...
impl Default for KeyBindings {
    fn default() -> Self {
        Self {
            ...
            jump_up: KeyList(vec![KeySpec::ctrl_char('u')]),
            jump_down: KeyList(vec![KeySpec::ctrl_char('d')]),
...
pub(super) struct KeysConfigOverride {
    ...
    jump_up: Option<KeyConfigOverride>,
    jump_down: Option<KeyConfigOverride>,
...
impl KeyBindings {
    ...
    fn bindings(&self) -> [(&KeyList, Action); 46] {
        [
            ...
            (&self.jump_up, Action::JumpUp),
            (&self.jump_down, Action::JumpDown),
    ...
    pub(super) fn from_override(overrides: KeysConfigOverride, defaults: &Self) -> Self {
        ...
        let raw = vec![
            ...
            RawBinding {
                ...
                override_value: overrides.jump_up,
                default: defaults.jump_up.clone(),
            },
            RawBinding {
                name: "jump_down",
                action: Action::JumpDown,
                override_value: overrides.jump_down,
                default: defaults.jump_down.clone(),
            },
            RawBinding {
                name: "jump_first",
        ...
        Self {
            ...
            search_select_up: resolved(43),
            search_select_down: resolved(44),
            cd_overlay: resolved(45),
        }
    }
}
