...
### Added: CD overlay and file path support in `elio <path>`
...
### Added: Go back to original directory (i.e., when `elio` is launched)
`src/app/state.rs`
...
### Added: More padding on Help / Search panels
...
### Added: Custom keybindings for Up/Down in Search panel
...
### Added: "Go to" panel shows top 5 destinations from "Places" panel
...
### Fixed: Some pre-existing test failures
...
### Fixed: Clean up some clippy warnings
